            ...
            <div class="right_side_content col-md-8">
                <div class="row">
                    ...
                    <div class="right_content">
                        <div class="dash_user">
                            <div class="col-md-5">
                                <div class="col-xs-4"><div class="row"><img src="images/dashboard/dash_user.png"></div></div>
                                <div class="col-xs-8"><h3>Robert Norton</h3><span>CEO Suit Industry</span></div>
                                <a href="#"><i class="fa fa-pencil"></i> Edit</a>
                            </div>
                            <div class="col-md-7">
                                <div class="col-xs-4 blue">
                                    <h3>3 455</h3>
                                    <p>Available <br> Credits</p>
                                    <button type="button" >OPEN</button>
                                </div>
                                <div class="col-xs-4 green" >
                                    <h3>3 455</h3>
                                    <p>Available Social Credits</p>
                                    <button type="button" >OPEN</button>
                                </div>
                                <div class="col-xs-4 red">
                                    <h3>3 455</h3>
                                    <p>Number of <br>Coins</p>
