              ...
              <ul class="list-inline tablist" role="tablist">
                ...
                <div class="tab-content">
                    ...
                    <form class="form-horizontal">
                      <div class="formulars">
                        ...
                        <div class="form-group">
                            <label for="field-profile-url" class="col-sm-4 col-md-2 control-label">Your Website URL:</label>
                  ...
                  <div role="tabpanel" class="tab-pane" id="stap2">
                    <form class="form-horizontal">
                      <div class="formulars">
                        <h3 class="ico-user">About You</h3>
                        <div class="form-group">
                      ...
                      <div class="formulars">
                        <h3 class="ico-formular">Capaign Details</h3>
